...
const ko = {
  ...
  createChallenge: '기기 서명 요청 만들기', challengeMessage: '기기에서 서명할 일회용 문장', deviceSignature: '기기 서명', registrationPayload: '기기에서 서명할 온체인 등록 데이터(EIP-712)', registrationSignature: '온체인 등록 기기 서명',
  ...
  disputeSettlement: '정산 이의 제기', disputeTitle: '정산 이의', disputeLead: '에폭 하나의 결산 결과에 이의를 제기합니다. 컴플라이언스가 검토해 인정하면 이의 창 안에서 온체인 루트에 이의를 걸고 결산을 다시 산출합니다.', disputeEpoch: '에폭', disputeReason: '사유', disputeNote: '설명 (10–500자, 개인정보·원문 없이)', disputeSubmit: '이의 제출', disputeSubmitting: '제출 중…', disputeSent: '이의가 접수되었습니다.', myDisputes: '내 이의', noDisputes: '제기한 이의가 없습니다.', disputeOpen: '검토 중', disputeUpheld: '인정', disputeRejected: '기각', disputeReview: '검토 의견',
  reasonTaskExcluded: '검증된 작업이 제외됨', reasonScoreUnderstated: '점수가 낮게 산정됨', reasonReceiptNotCounted: '결과·삭제 확인서가 반영되지 않음', reasonPolicyMismatch: '정책 버전 불일치', reasonOther: '기타',
...
const en: Record<keyof typeof ko, string> = {
  ...
  createChallenge: 'Create device signing request', challengeMessage: 'One-time message to sign on the device', deviceSignature: 'Device signature', registrationPayload: 'Onchain registration data to sign on the device (EIP-712)', registrationSignature: 'Device signature for onchain registration',
  ...
  disputeSettlement: 'Dispute settlement', disputeTitle: 'Settlement dispute', disputeLead: 'Object to one epoch’s settlement. If compliance upholds it, the onchain root is challenged inside the challenge window and the settlement is rebuilt.', disputeEpoch: 'Epoch', disputeReason: 'Reason', disputeNote: 'Explanation (10–500 characters, no personal data or raw records)', disputeSubmit: 'Submit dispute', disputeSubmitting: 'Submitting…', disputeSent: 'The dispute was recorded.', myDisputes: 'My disputes', noDisputes: 'No disputes raised.', disputeOpen: 'Under review', disputeUpheld: 'Upheld', disputeRejected: 'Rejected', disputeReview: 'Review note',
  reasonTaskExcluded: 'A verified task was excluded', reasonScoreUnderstated: 'The score is understated', reasonReceiptNotCounted: 'A result or deletion receipt was not counted', reasonPolicyMismatch: 'Policy version mismatch', reasonOther: 'Other',
