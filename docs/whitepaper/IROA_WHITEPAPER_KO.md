...
![사용자 요청이 AI 지원, 보안 실행, 검증 NODE, 사람 도움과 완료 증명으로 이어지는 IROA 생태계](../brand/assets/illustrations/iroa-whitepaper-cover-v1.png)
...
![사용자의 태블릿 요청이 보호된 AI 계획, 검증 실행, 사람 지원과 완료 증명으로 이어지는 IROA 제품 체계](../brand/assets/illustrations/iroa-product-system-v1.png)
...
![스마트워치에서 시작한 요청과 승인이 IROA NODE의 검증 결과로 돌아오는 과정](../brand/assets/illustrations/iroa-wearable-request-v1.png)
...
![요청별 작업 보호 꾸러미가 세 개의 격리 NODE에서 실행되고 검증 증명으로 합쳐지는 보안 실행 공간](../brand/assets/illustrations/iroa-secure-execution-v1.png)
...
![가정용 반려기기가 사용자의 복잡한 요청을 사람 지원자에게 안전하게 인계하는 과정](../brand/assets/illustrations/iroa-companion-handoff-v1.png)
...
![휠체어 이용자가 접근 가능한 키오스크에서 요청하고 승인한 뒤 검증된 정산과 영수증을 받는 과정](../brand/assets/illustrations/iroa-kiosk-settlement-v1.png)
...
![사용자가 필요한 건강정보만 승인하고 보호된 요약을 의료진에게 전달하는 동의 중심 병원 연계](../brand/assets/illustrations/iroa-health-consent-v1.png)
...
![사용자, 도움 제공자, 기관과 인프라 NODE의 검증된 기여가 지역사회 보상으로 연결되는 생태계](../brand/assets/illustrations/iroa-reward-community-v1.png)
