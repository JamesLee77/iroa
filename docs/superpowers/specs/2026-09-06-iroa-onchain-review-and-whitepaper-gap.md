...
**결정(2026-09-06): (a).** 합의서 v0.2(`iroa-archive/agreement/`)가 제5조를 24개월 절벽 + 72개월 선형 귀속으로 바꾸고, 미귀속 토큰은 창립자 소유가 아니므로 반환의무 대신 귀속 중단으로 처리한다. 금고 수익자는 재단 관리 팀 다중서명 지갑이며 해제분을 별지 1 비율로 창립자에게 이전한다. 온체인과 백서는 변경 없음.
